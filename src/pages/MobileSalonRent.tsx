...
const MobileSalonRentPage: React.FC = () => (
  <div className="mint-framed-media-page">
    ...
    <section className="relative overflow-hidden border-y-4 border-[#f49ca3] bg-background py-16 md:py-20">
      <img src="/images/page/subpage/sanna_rent.png" alt="" aria-hidden="true" className="absolute inset-0 hidden h-full w-full object-cover md:block" />
      <img src="/images/page/subpage/sanna_mobile-rent.png" alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover md:hidden" />
    ...
    <section className="relative overflow-hidden border-b-4 border-[#f49ca3] bg-background py-14 md:py-16">
      <img src="/images/page/subpage/sanna_faq.png" alt="" aria-hidden="true" className="absolute inset-0 hidden h-full w-full object-cover md:block" />
      <img src="/images/page/subpage/sanna_mobile-faq.png" alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover md:hidden" />
      <div className="relative z-[1] container mx-auto max-w-3xl px-4">
