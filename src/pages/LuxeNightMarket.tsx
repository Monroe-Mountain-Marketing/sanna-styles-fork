...
const LuxeNightMarketPage: React.FC = () => {
  ...
  <div>
    <section
      ...
      style={{ backgroundImage: "url('/images/stock/passion-disco.jpeg')" }}
    >
      <div className="absolute inset-0 bg-white/65" aria-hidden="true" />
      <div className="relative container mx-auto px-4 text-center">
        <h1 className="text-4xl font-bold text-primary md:text-5xl">The Luxe Night Market By Sanna Styles</h1>
    ...
    <section className="border-y-4 border-[#ff2c56] bg-background py-14 md:py-16">
      <div className="container mx-auto px-4">
        <div className="grid items-center gap-8 md:grid-cols-[minmax(280px,440px)_1fr] md:gap-10">
          <img
            src="/images/sanna/events/luxenight.jpg"
    ...
    <section className="border-b-4 border-[#ff2c56] bg-background py-14 md:py-16">
      <div className="container mx-auto px-4">
        <div className="flex items-center gap-3">
          <button
            ...
            className="shrink-0 rounded-full border border-border bg-white p-2 shadow-sm hover:bg-muted"
          >
