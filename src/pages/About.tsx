...
const AboutPage: React.FC = () => (
  <div className="mint-framed-media-page">
    ...
    <section className="relative overflow-hidden border-t-4 border-[#f49ca3] bg-background py-14 md:py-16">
      <img src="/images/page/subpage/sanna_about.png" alt="" aria-hidden="true" className="absolute inset-0 hidden h-full w-full object-cover md:block" />
      <img src="/images/page/subpage/sanna_mobile-about.png" alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover md:hidden" />
