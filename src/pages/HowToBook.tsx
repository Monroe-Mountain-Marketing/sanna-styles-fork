...
const HowToBookPage: React.FC = () => (
  <div>
    ...
    <section className="relative overflow-hidden border-y-4 border-[#f49ca3] bg-background py-14 md:py-16">
      <img src="/images/page/subpage/sanna_booking.png" alt="" aria-hidden="true" className="absolute inset-0 hidden h-full w-full object-cover md:block" />
      <img src="/images/page/subpage/sanna_mobile-booking.png" alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover md:hidden" />
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((item) => (
            <article key={item.step} className="flex flex-col rounded-none double-accent-left bg-transparent p-0 pl-4">
              ...
              {item.cta && (
                <Button asChild className="mt-4 h-9 w-fit border-2 border-[#ed3559] bg-white px-5 text-sm font-semibold text-black hover:bg-[#ed3559] hover:text-black">
    ...
    <section className="relative overflow-hidden border-b-4 border-[#f49ca3] bg-muted/40 py-14 md:py-16">
      <img src="/images/page/subpage/sanna_book-event.png" alt="" aria-hidden="true" className="absolute inset-0 hidden h-full w-full object-cover md:block" />
      <img src="/images/page/subpage/sanna_mobile-book-event.png" alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover md:hidden" />
      <img
